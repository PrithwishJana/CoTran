...
from codegen.preprocessing.lang_processors.tokenization_utils import process_string
from codegen.preprocessing.lang_processors.lang_processor import LangProcessor
from codegen.preprocessing.obfuscation.bobskater_obfuscator import obfuscateString
        ...
        try:
            for toktype, tok, _, _, line in tokenize.tokenize(
                ...
                if toktype == tokenize.STRING or toktype == tokenize.COMMENT:
                    ...
                    #print ("line", line)
                    #print ("xxxyyyy", untok_s)
                    untok_s = untok_s.replace(tok, tok_)
            untok_s = untok_s.replace("SPACETOKEN", " ")
