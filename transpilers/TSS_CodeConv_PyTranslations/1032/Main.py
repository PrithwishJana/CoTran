...
#JAVA TO PYTHON CONVERTER TASK: Python does not allow method overloads:
    def main(args):
        Main.read = Scanner(System.in)
        Main.a = Main.read.nextInt()
        Main.b = Main.read.nextInt()
        Main.n = Main.a + Main.b
        if Main.b >= Main.a:
            print("Impossible", end = '')
        else:
            ans = ""
            honest = Main.getHonest()
            i = 0
            while i < Main.n:
                ans += '1' if Main.q(honest, i) else '0'
                i += 1
            print("! " + ans, end = '')
    @staticmethod
    def getHonest():
